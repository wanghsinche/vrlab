...
export default defineConfig({
  ...
  routes: [
    ...
    {path: '/manage', name: 'Manage', icon: 'AppstoreOutlined', routes: [
      ...
      { path: 'coursemgr/:id', component: '@/pages/coursemgr/detail',
      access: 'forTeacher',
      },
    ]},
  ...
  favicon: 'data:image/png;base64,',
  define:{
